...
export function Field({ label, value, onChangeText, suffix }) {
  return (
    <View style={styles.fieldWrap}>
      <Text style={styles.inputLabel}>{label}</Text>
      <View style={styles.field}>
        <TextInput value={String(value)} onChangeText={onChangeText} style={styles.input} />
  ...
  return (
    <Card style={[styles.aiCard, compact && styles.aiCardCompact]}>
      ...
      <View style={styles.flex}>
        <Text style={styles.mediumTitle}>AI Sidecar</Text>
